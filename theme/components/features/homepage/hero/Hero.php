...
<div id="hero" class="bg-background relative flex flex-col justify-between items-center gap-10 h-full">
    ...
    <div class="absolute top-[50%] translate-y-[-50%] px-5 flex flex-col md:flex-row md:justify-center w-full md:px-20 md:-mt-20 gap-16 md:gap-24">
        <div class="text-center md:text-left flex flex-col gap-2 items-center md:items-start relative z-10 lg:-mt-20 md:w-4/12">
            ...
            <a href="/about" class="link mt-6">More About Us <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg></a>

        </div>
        <div class="text-center flex flex-col gap-2 items-center relative z-10 md:w-[200px] h-[200px] md:mt-20">
        ...
        <div class="text-center flex flex-col items-center md:items-end relative z-10 font-secondary  md:mt-40 md:w-4/12">
            <div class="flex">
                <h2 class="hero-text-large capitalize text-neutral-800">Smile</h2><img src="/wp-content/themes/dental1/theme/assets/images/arrow-scribble.png" alt="dental 1 smiling women after dental care" width="202" height="135" class="-ml-2 w-20 self-end pt-10" />
            </div>
            <div class="flex gap-0 items-center">
                <div class="w-4/12"><?php echo $doubledash; ?></div>
                <h2 class="hero-text-medium text-primary  capitalize">Beauty</h2>
            </div>
        </div>
    </div>
