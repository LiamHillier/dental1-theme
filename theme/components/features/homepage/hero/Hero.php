...
<div class="embla relative hero" id="hero">
    <div class="embla__container h-full min-h-[600px] md:min-h-[900px]">
        <div class="embla__slide">
            <div class="relative flex flex-col justify-start md:justify-center items-start gap-10 h-full  px-5 md:px-0 !pt-20   overflow-hidden pb-52 md:pb-40 md:!pt-[70px] bg-gradient-to-tl from-sky-50 to-gray-100">
