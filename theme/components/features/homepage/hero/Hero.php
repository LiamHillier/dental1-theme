        ...
        <div class="embla__slide">
            <div class="relative flex flex-col justify-center items-start gap-10 h-full  px-10 md:px-0   overflow-hidden pb-52 md:pb-40 md:pt-[70px] bg-gradient-to-tl from-sky-50 to-gray-100">
                ...
                <div class="relative z-20 w-full max-w-screen-2xl mx-auto py-4 md:px-20">
                    ...
                    <p class="text-base md:text-lg mt-6 max-w-xl ">Our caring professional team of Dentists in Craigieburn, Templestowe, Epping North, Essendon, Richmond and Reservoir are here to provide the best ongoing dental care and guidance for you and your family.</p>
