...
<div class="embla relative hero " id="hero">
    <div class="embla__container h-full min-h-[700px] md:min-h-[900px]">
        ...
        <div class="embla__slide">
            <div class="relative flex flex-col justify-start md:justify-center items-start gap-10 h-full  px-5 md:px-0 !pt-40   overflow-hidden pb-52 md:pb-40 md:!pt-[70px] bg-gradient-to-tl from-sky-50 to-gray-100">
                <div class="bg-gradient-to-l from-transparent to-white h-full w-10/12 absolute top-0 left-0 z-10 hidden md:block"></div>
  ...
  src="/wp-content/themes/dental1/theme/assets/images/hero/Essendon photo 3_edited.jpg"
  alt="Dental One Essendon" class="mobile-hero block object-cover absolute top-0 left-0 w-full h-full" />
                <div class="relative z-20 w-full max-w-screen-2xl mx-auto py-4 md:px-20">
