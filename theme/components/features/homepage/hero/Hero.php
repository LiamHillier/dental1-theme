...
<div id="hero" class="bg-background relative flex flex-col justify-between items-center gap-10 h-full">
    <img alt="dental 1 smiling women after dental care"
        ...
        src="/wp-content/themes/dental1/theme/assets/images/hero/banner-image 1 (1).png"
        alt="lady smiling after dental appointment at dental1" />
    <div
        class="absolute top-[50%] translate-y-[-50%] px-5 flex flex-col md:flex-row md:justify-between w-full md:px-20 md:-mt-20 gap-16 md:gap-24 max-w-screen-2xl mx-auto">
        <div
            class="text-center md:text-left flex flex-col gap-2 items-center md:items-start relative z-10 lg:-mt-20 md:w-4/12 ">
            <h1 class="font-accent hero-text-medium animate__animated animate__fadeInUp">Welcome to Dental<span
                    class="text-primary">One</span></h1>
            ...
            <a href="/about" class="link mt-6 animate__animated animate__fadeInUp animate__delay-1s">More About Us <svg
        ...
        <div
            class="text-center flex flex-col gap-2 items-center relative z-10 md:w-[200px] h-[200px] md:mt-20 animate__animated animate__bounceIn animate__slow">
        ...
        <div
            class="text-center flex flex-col items-center md:items-end relative z-10 font-secondary  md:mt-40 md:w-4/12">
            <div class="flex">
                <h2 class="animate__animated animate__fadeInUp hero-text-large capitalize text-neutral-800">
                    Smile</h2>
                <img src="/wp-content/themes/dental1/theme/assets/images/arrow-scribble.png"
                    alt="dental 1 smiling women after dental care" width="202" height="135"
                    class="-ml-2 w-20 self-end pt-10" />
            </div>
...
<div id="container" class="-mt-24 md:-mt-80">
    <div id="circle" class="animate__initial animate__animated animate__fadeInUp animate__slow animate__delay-1s">
