<section id="locations" class="pt-10 bg-gray-100 pb-36 relative -mb-1">
    <div class="">
        ...
        <!-- Locations carousel -->
        <section id="locations-carousel" class="embla locations-carousel">
            <div class=" mt-4 md:mt-0 flex gap-4 justify-center md:justify-end animate__initial animate__animated animate__fadeInUp">
                ...
                <button class="embla__next bg-primary text-white rounded-full p-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
