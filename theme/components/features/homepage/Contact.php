...
<section id="contact" class="text-center relative bg-gray-100 -mt-1 pt-20 pb-32">
    ...
    <p class="px-5 ">Whether you have a dental emergency, need to get some advice or just want to get a regular
        check-up, our team of Dentists is here to help. With the convenience of flexible booking times, a brand new
        clinic and affordable pricing we know you'll want to make your next appointment at Dental One. Get in touch with
        us today by calling, emailing or filling in our booking form and we'll book you in to see one of our team of
        professional and caring dentists.​<br /><br />Simply fill in your details below and we will contact you to
        resolve any queries and to confirm your appointment.</p>
    <div class="grid grid-cols-2 gap-x-4 gap-y-10 px-10 my-10 max-w-xl mx-auto">
