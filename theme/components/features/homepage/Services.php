<section id="services" class="text-center relative bg-white -mt-1 py-20 md:pt-40">
    <header class="px-5  md:px-20 md:grid md:grid-cols-2 text-left">
        <div>
            <p class="mb-2 text-primary pre-header">Our services</p>
        ...
        <div class="md:place-self-end max-w-xl">
            ...
            <a href="/book-online" class="link mt-6">View services <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block ml-1">
    ...
    <div class="desktop-service-select hidden md:flex">
        <p class="uppercase text-black text-left pl-4 py-4 border-b w-full text-sm">Select a service</a>
        <ul>
            <li><?php get_template_part('components/features/homepage/services/dropdowns/ChildrensDentistry'); ?></li>
            <li><?php get_template_part('components/features/homepage/services/dropdowns/CosmeticDentistry'); ?></li>
        </ul>
    ...
    <div class="service-content px-5 mt-8 md:px-20">
