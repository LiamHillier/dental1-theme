<section id="services" class="text-center relative bg-white -mt-1 py-20 md:pt-40">
    <header class="px-5  md:px-20 md:grid md:grid-cols-2 text-left max-w-screen-2xl mx-auto">
        <div>
            ...
            <h2 class="mb-4 font-semibold">Personalized, Comprehensive <span class="text-primary">Treatment</span></h2>
        </div>
    ...
    <div class="relative max-w-screen-2xl mx-auto">
        <div class="desktop-service-select hidden md:flex">
            ...
            <a href="/services" class="link ml-4 text-gray-600 font-light  my-10">More services <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg></a>
        </div>
    </div>
