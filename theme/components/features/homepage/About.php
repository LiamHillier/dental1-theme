    ...
    <div class="max-w-screen-2xl mx-auto relative">
        ...
        <div class="relative">
            <div class="relative z-10">
                ...
                <!-- <div class="w-24 h-24 md:w-[16vw] md:h-[16vw] md:max-w-[170px] absolute right-16 md:left-[200px] lg:left-[400px] top-[50%] translate-y-[-50%]  animate__bounceIn animate__slow">
                    <?php echo $badge; ?>
                </div> -->
            </div>
        </div>
