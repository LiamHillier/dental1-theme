...
<section id="about" class="text-center relative pb-0 ">
    <div class="max-w-screen-2xl mx-auto relative">
        ...
        <header class="px-5 md:absolute md:right-20 md:w-4/12 md:text-left md:top-1/2 md:-translate-y-1/2 md:z-20 md:pb-20">
            ...
            <h2 class="mb-4 font-semibold">Discover the dental elegance at <span class="text-primary">DentalOne</span>
            </h2>
        ...
        <div class="relative mt-10">
            <div class="relative z-10">
                ...
                <div class="w-24 h-24 md:w-[16vw] md:h-[16vw] md:max-w-[170px] absolute right-16 md:left-[200px] lg:left-[400px] top-[50%] translate-y-[-50%]">
                    <?php echo $badge; ?>
                </div>
            </div>
        </div>
