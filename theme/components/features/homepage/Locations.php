    ...
    <div class=" max-w-screen-2xl mx-auto relative">
        ...
        <div class="md:px-20 max-w-screen-2xl mx-auto md:flex justify-between items-center md:flex-wrap md:gap-10">
            ...
            <div class="hidden md:block md:w-full lg:w-4/12">
                ...
                <div class="relative">
                    ...
                    <div class="bg-primary text-white rounded-lg p-2 absolute right-4 top-[50%] translate-y-[-50%]"><svg
        ...
        <ul class="mt-10 font-semibold text-lg flex flex-col gap-2 md:hidden" id="location-list">
            ...
            <li class="px-4 py-2 rounded-full" data-title="Lower Templestowe" data-phone="(03) 9581 2628"
                ...
                Templestowe</li>
            <li class="px-4 py-2 rounded-full" data-title="Epping" data-phone="(03) 9039 6597"
        ...
        <div class="grid grid-cols-5 gap-4 bg-white shadow p-4 rounded-xl items-center mt-8 " id="location-details">
            ...
            <div class="col-span-3">
                ...
                <a href="#" class="text-sm flex gap-4 items-center text-gray-500 hover:text-primary"
                    id="location-phone">
                ...
                <div class="text-sm text-gra 46 2.02 6.837 3.963 8.827a19.58 19.58 0 002.682 2.282 16.975 16.975 0 001.145.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z"
                    clip-rule="evenodd" />
                </svg>
