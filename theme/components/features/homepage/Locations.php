<section id="locations" class="pt-10 bg-gray-100 pb-36 px-5 relative -mb-1">
    ...
    <ul class="mt-10 font-semibold text-lg flex flex-col gap-2 md:hidden" id="location-list">
        <li class="px-4 py-2 rounded-full " data-title="Craigieburn" data-phone="(03) 9021 8928"
            data-address="31 Craigieburn Road, Craigieburn" data-email="info@dental1.com.au">Craigieburn</li>
        <li class="px-4 py-2 rounded-full" data-title="Lower Templestowe" data-phone="(03) 9581 2628"
            data-address="275 Manningham Road Lower Templestowe, VIC 3107" data-email="info@dental1.com.au">Lower
            Templestowe</li>
        <li class="px-4 py-2 rounded-full" data-title="Epping North" data-phone="(03) 9039 6597"
            data-address="1/341 Harvest Home Road, Epping VIC 3076" data-email="info@dental1.com.au">Epping North
        </li>
        <li class="px-4 py-2 rounded-full" data-title="Essendon" data-phone="(03) 9969 2841"
            data-address="Level 1, 1003 Mt Alexander Rd, Essendon" data-email="info@dental1.com.au">Essendon</li>
        <li class="px-4 py-2 rounded-full" data-title="Richmond" data-phone="(03) 9113 9313"
            data-address="Inside Medical One Victoria Gardens Shopping Centre, Level 1, 620 Victoria Street Richmond VIC 3121"
            data-email="info@dental1.com.au">Richmond</li>
        <li class="px-4 py-2 rounded-full" data-title="Reservoir" data-phone="(03) 9059 4045"
            data-address="319 Spring St, Reservoir VIC 3073" data-email="info@dental1.com.au">Reservoir</li>
    </ul>
    <div class="grid grid-cols-5 gap-4 bg-white shadow p-4 rounded-xl items-center mt-8" id="location-details">
        <div class="col-span-2 h-full">
            <img src="/wp-content/themes/dental1/theme/assets/images/craigieburn.jpg"
                class="rounded-lg border-2 border-white shadow h-full object-cover" />
        </div>
        <div class="col-span-3">
            ...
            <a href="#" class="text-sm flex gap-4 items-center text-gray-500 hover:text-primary" id="location-email">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="shrink-0 h-4 mt-1 text-primary">
            ...
            <div class="text-sm text-gray-500 hover:text-primary flex gap-4 items-center " id="location-address">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="shrink-0 w-4 h-4 mt-1 text-primary">
                    <path fill-rule="evenodd"
