    ...
    <section id="services" class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-start justify-between mt-20 gap-y-16">
            ...
            <a href="/payment-options/" class="flex flex-col gap-2 items-center">
                ...
                <p class="text-center">Available for larger treatments, our financing options enable you to split the payment on treatments that can leave a dent in your pocket.</p>
            </a>
        </div>
    </section>
<?php
...
?>
    <section id="locations" class="!pl-0 relative -mb-1 overflow-visible alt-locations">
        <div class="">
            ...
            <button class="embla__prev absolute -left-4 md:-left-10 top-[50%] z-10 bg-primary text-white rounded-full p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    <path fill-rule="evenodd" d="M20.25 12a.75.75 0 01-.75.75H6.31l5.47 5.47a.75.75 0 11-1.06 1.06l-6.75-6.75a.75.75 0 010-1.06l6.75-6.75a.75.75 0 111.06 1.06l-5.47 5.47H19.5a.75.75 0 01.75.75z" clip-rule="evenodd" />
                </svg>
            </button>
            <button class="embla__next absolute -right-4 md:-right-10 top-[50%] z-10 bg-primary text-white rounded-full p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
