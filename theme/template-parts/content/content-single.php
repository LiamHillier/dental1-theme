...
<div id="banner" class="relative overflow-hidden min-h-[176px] md:min-h-[200px] flex items-center justify-center">
	...
	<header class="max-w-screen-2xl mx-auto px-5 md:px-20 mt-10">
		<?php the_title( '<h1 class="entry-title text-center">', '</h1>' ); ?>

	</header><!-- .entry-header -->


	<div class="max-w-screen-2xl mx-auto px-5 md:px-20 mt-10">
		
	<?php dental1_post_thumbnail(); ?>


<div <?php dental1_content_class( 'entry-content mt-10' ); ?>>
	<?php
	the_content(
		sprintf(
			wp_kses(
				/* translators: %s: Name of current post. Only visible to screen readers. */
				__( 'Continue reading<span class="sr-only"> "%s"</span>', 'dental1' ),
				array(
					'span' => array(
						'class' => array(),
					),
