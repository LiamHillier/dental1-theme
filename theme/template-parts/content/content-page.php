...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="banner" class="relative overflow-hidden min-h-[276px] md:min-h-[400px] flex items-center justify-center">
		<div class="bg-gradient-to-t from-transparent to-white h-[180px] w-full absolute top-0 left-0 z-10"></div>
		<div class="bg-gradient-to-t from-white to-transparent h-full w-full absolute bottom-0 left-0 z-10"></div>
		<div class="absolute top-0 left-0 w-full h-full object-cover">
			<?php dental1_post_thumbnail(); ?>
		</div>

		<div class="relative z-10">
			<h1 class="text-center font-bold pt-8 pb-10 text-primary"><?php echo get_the_title(); ?></h1>
		</div>
