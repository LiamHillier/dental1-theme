...
function is_within_enquiry_hours($current_time, $start_time, $end_time)
{
    ...
    // If end time is after midnight, adjust the comparison
...
<header id="masthead" class="w-screen sticky <?php echo is_within_enquiry_hours($current_time, $start_time, $end_time) ? 'top-[36px]' : 'top-0'; ?> lg:top-0 left-0 z-[100] bg-transparent transition-colors duration-100 ease-in -mb-[112px]">
