...
<header id="masthead" class="w-screen sticky <?php echo is_within_enquiry_hours($current_time, $start_time, $end_time) ? 'top-[36px]' : 'top-0'; ?> lg:top-0 left-0 z-50 bg-transparent transition-colors duration-100 ease-in -mb-[112px]">
