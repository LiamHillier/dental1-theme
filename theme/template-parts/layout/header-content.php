...
<div id="top-bar" class="lg:hidden font-semibold w-full text-white bg-primary z-50 sticky top-0">
	<div class=" max-w-screen-2xl  mx-auto px-5 md:px-20 py-2 text-sm flex justify-between gap-4">
		...
		<div class="gap-4 items-center flex ">
			<a href="/dental-emergencies/" class="text-white text-sm font-semibold relative flex underline items-center gap-1">
				...
				<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="16px" height="16px" viewBox="-32 0 512 512" class="w-4-h-4 mt-[2px]  ">
...
<header id="masthead" class="w-screen sticky top-[36px] lg:top-0 left-0 z-50 bg-transparent transition-colors duration-300 ease-in -mb-[112px]">
