...
<header id="masthead" class="w-screen sticky top-0 left-0 z-50 bg-transparent transition-colors duration-300 ease-in -mb-[112px] overflow-x-hidden">
...
<div class="mobile-menu hidden md:hidden flex flex-col items-stretch justify-start fixed w-screen h-screen bg-white top-0 z-50 pt-24 px-10">
	...
	<nav id="site-navigation" aria-label="<?php esc_attr_e('Main Right  Navigation', 'dental1'); ?>" class="">
			<?php
			wp_nav_menu(
				array(
					'theme_location' => 'main-right',
