                ...
                <div class="lg:pl-20 flex flex-col gap-6 justify-center">
                    <div class="bg-white rounded-full p-4 w-full flex items-center gap-8 relative">
                        ...
                        <span class="absolute right-10"><svg width="34" height="33" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M22.2423 1.01843C22.6329 0.53015 23.4141 0.53015 23.9024 1.01843L44.3126 21.4287C44.8009 21.9169 44.8009 22.6005 44.3126 23.0888L23.9024 43.499C23.4141 43.9873 22.6329 43.9873 22.2423 43.499L20.2891 41.6436C19.8008 41.1553 19.8008 40.374 20.2891 39.9834L35.4259 24.749H2.125C1.44141 24.749 0.953125 24.2607 0.953125 23.5771V20.8427C0.953125 20.2568 1.44141 19.6708 2.125 19.6708H35.4259L20.2891 4.53407C19.8008 4.14344 19.8008 3.36219 20.2891 2.87391L22.2423 1.01843Z" fill="#0EBAB0" />
                            </svg>
                        </span>
                    </div>
                    <div class="bg-white rounded-full p-4 w-full flex items-center gap-8 relative">
